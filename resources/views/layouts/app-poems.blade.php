...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('future-imperfect/assets/css/main.css') }}?<?php echo time(); ?>" />
    ...
    <body class="is-preload future-imperfect">
        ...
        <!-- Scripts -->
        <script src="{{ asset('future-imperfect/assets/js/jquery.min.js') }}?<?php echo time(); ?>"></script>
        <script src="{{ asset('future-imperfect/assets/js/browser.min.js') }}?<?php echo time(); ?>"></script>
        <script src="{{ asset('future-imperfect/assets/js/breakpoints.min.js') }}?<?php echo time(); ?>"></script>
        <script src="{{ asset('future-imperfect/assets/js/util.js') }}?<?php echo time(); ?>"></script>
        <script src="{{ asset('future-imperfect/assets/js/main.js') }}?<?php echo time(); ?>"></script>
